...
sisyphus_set=None, minimized_set=None, descriptors=None, acsf_parameters=None):
    ...
    @staticmethod
    def parse_sisyphus_xyz(filename, energy, specorder):
        """
        Reads a '*minimum*.xyz' or '*saddlepoint*xyz' file generated by Sisyphus and returns
        an ASE Atoms object with forces and energy.
        Energy should be explicitly given (it is assumed it's read from minima_energies or saddlepoint_energies).
        """
