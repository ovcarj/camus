...
class Map(abc.ABC):
    """
    Maps from calculation types, methods and engines to the corresponding batch creation mode. 
    ...
    def _define_maps(self):
        """
        Defines ``self.maps`` dictionary from (calc_type, method, engine) to (Batch)Calc modules and classes.
...
class BatchMap(Map):
    """
    Maps from calculation types, methods and engines to the corresponding BatchCalc classes.

    """

    def __init__(self, calc_type=None, method=None, engine=None):
        """
        List all implemented batch calculation types, methods and engines. 
        
        If given, map the calculation type, method and engine to the corresponding implementation of the BatchCalc class.
        ...
        super().__init__(calc_type=calc_type, method=method, engine = engine)

    @abc.abstractmethod
    def _define_maps(self):
        """
        Defines maps from (calc_type, method, engine) to BatchCalc modules and classes.
...
class CalcMap(Map):
    ...
    def __init__(self, calc_type=None, method=None, engine=None):
        """
        List all implemented calculation types, methods and engines. 
        
        If given, map the calculation type, method and engine to the corresponding implementation of the Calc class.
